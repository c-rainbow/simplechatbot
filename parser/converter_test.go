...
func TestConvertNoVariable(t *testing.T) {
	...
	message, err := ConvertResponse(response, "test_channel", nil, nil, nil)
	assert.Nil(t, err)
...
func TestConvertVariableNotEnabled1(t *testing.T) {
	...
	_, err := ConvertResponse(response, "test_channel", nil, nil, nil)
...
func TestConvertArguments(t *testing.T) {
	...
	message, err := ConvertResponse(response, "test_channel", nil, nil, args)
	assert.Nil(t, err)
...
func TestConvertUnsupportedType(t *testing.T) {
	...
	_, err := ConvertResponse(response, "", nil, nil, nil)
